...
import com.hq.scrati.common.util.signature.key.KeyReader;
...
public class RSASignWithFile {
	 ...
	 * @throws Exception
	 */
	public static boolean validateSign(byte[] data, byte[] signedData, PublicKey publicKey) throws Exception {
		Signature signature = Signature.getInstance("SHA1withRSA");
