package com.hq.diego.gateway.constant;
...
public class WxErrorCenter {
    ...
    private static void init() {
        ...
        if(errors.isEmpty()) {
            ...
            errors.put(0, "请求成功");
            errors.put(40001, "获取access_token时AppSecret错误,或者access_token无效");
            errors.put(40002, "不合法的凭证类型");
            errors.put(40003, "不合法的OpenID,请确认OpenID(该用户)是否已关注公众号,或是否是其他公众号的OpenID");
            ...
            errors.put(40013, "不合法的AppID,请检查AppID的正确性,避免异常字符,注意大小写");
            errors.put(40014, "不合法的access_token,请确认access_token的有效性(如是否过期)");
            ...
            errors.put(40033, "不合法的请求字符,不能包含特殊字符");
            ...
            errors.put(42001, "access_token超时,请检查access_token的有效期");
            ...
            errors.put(48001, "api功能未授权,请确认公众号已获得该接口");
            ...
            errors.put(61454, "客服帐号名长度超过限制(仅允许10个英文字符,不包括@及@后的公众号的微信号)");
            errors.put(61455, "客服帐号名包含非法字符(仅允许英文 + 数字)");
            errors.put(61456, "客服帐号个数超过限制(10个客服账号)");
            errors.put(61457, "无效头像文件类型");
            errors.put(61450, "系统错误");
