...
//        return new sun.misc.BASE64Encoder().encode(cipher.doFinal(data));
    ...
    public static String encryptBasedDes(String data) {
        ...
        try {
            ...
            // 加密，并把字节数组编码成字符串
            encryptedData = Base64Util.encryptBASE64(cipher.doFinal(data.getBytes()));
        } catch (Exception e) {
//            log.error("加密错误，错误信息：", e);
    ...
    public static String decryptBasedDes(String cryptData) {
        ...
        try {
            ...
            // 把字符串解码为字节数组，并解密
            decryptedData = new String(cipher.doFinal(Base64Util.decryptBASE64(cryptData)));
        } catch (Exception e) {
