...
/**
 * Created by huwentao on 16/10/21.
 */
...
public abstract class MyFragmentAdapter extends PagerAdapter {
     ...
     */
    public abstract HqPayFragment getItem(int position);
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        if (fragment != null) {
            Logger.v("Attaching item #" + tag + ": f=" + fragment);
            mCurTransaction.attach(fragment);
        } else {
            fragment = getItem(position);
            Logger.v(TAG, "Adding item #" + tag + ": f=" + fragment);
