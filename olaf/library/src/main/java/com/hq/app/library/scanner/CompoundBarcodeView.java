...
import com.hq.app.library.android.DecodeFormatManager;
import com.hq.app.library.android.DecodeHintManager;
...
public class CompoundBarcodeView extends FrameLayout {
    ...
    private void initialize(AttributeSet attrs) {
        ...
        moneyView = (TextView) findViewById(R.id.zxing_money);
    }
    ...
    public void setMoneyViewText(String money) {
        // statusView is optional when using a custom layout
        if(moneyView != null) {
