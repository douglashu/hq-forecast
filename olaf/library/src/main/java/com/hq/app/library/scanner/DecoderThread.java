...
import com.hq.app.library.scanner.camera.PreviewCallback;
    ...
    private void decode(SourceData sourceData) {
        ...
        if (rawResult != null) {
            ...
            if (resultHandler != null) {
                ...
                Message message = Message.obtain(resultHandler, BarcodeView.ZXING_DECODE_SUCCEEDED, barcodeResult);
            ...
            if (resultHandler != null) {
                Message message = Message.obtain(resultHandler,BarcodeView.ZXING_DECODE_FAILED);
                message.sendToTarget();
            }
        }
        if (resultHandler != null) {
            List<ResultPoint> resultPoints = decoder.getPossibleResultPoints();
            Message message = Message.obtain(resultHandler, BarcodeView.ZXING_POSSIBLE_RESULT_POINTS, resultPoints);
            message.sendToTarget();
        }
        requestNextPreview();
    }
