...
public class BarcodeView extends CameraPreview {
    ...
    public static int ZXING_DECODE_SUCCEEDED =100001;
    public static int ZXING_DECODE_FAILED =100002;
    public static int ZXING_POSSIBLE_RESULT_POINTS =100003;
    ...
    private final Handler.Callback resultCallback = new Handler.Callback() {
        ...
        public boolean handleMessage(Message message) {
            if (message.what == ZXING_DECODE_SUCCEEDED) {
                ...
                return true;
            } else if (message.what == ZXING_DECODE_FAILED) {
                // Failed. Next preview is automatically tried.
                return true;
            } else if (message.what == ZXING_POSSIBLE_RESULT_POINTS) {
